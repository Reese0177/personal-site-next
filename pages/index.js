        ...
        <div id={styles.timeline}>
          <div className={styles.row}>
            <div className={styles.column}>
              <h2 className={styles.columnHeader}>Past</h2>
            ...
            <div className={styles.column}>
              <h2 className={styles.columnHeader}>Present</h2>
            ...
            <div className={styles.column}>
              <h2 className={styles.columnHeader}>Future</h2>
              ...
              <p>In terms of more personal goals, I would like to move back to a place like Nashville, although Atlanta is on the list, too, and buy my own house. I hope to accomplish that in the much nearer future, hopefully in the next few years.</p>
            </div>
          </div>
        </div>
      </section>
